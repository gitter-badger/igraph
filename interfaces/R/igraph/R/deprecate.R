...
deprecated("betweenness.estimate", betweenness_estimate)
...
deprecated("closeness.estimate", closeness_estimate)
...
deprecated("degree.distribution", degree_dist)
...
deprecated("edge.betweenness.estimate", edge_betweenness_estimate)
...
deprecated("get.data.frame", get_data_frame)
